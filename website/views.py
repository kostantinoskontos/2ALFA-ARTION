    ...
    PitesImage_data = [
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 1500gr<br />Τεμάχια ανά κιβώτιο/κιλά: 5<br />Κιβώτια ανά παλέτα: 92",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 1600gr<br />Τεμάχια ανά κιβώτιο/κιλά: 4<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 2300gr<br />Τεμάχια ανά κιβώτιο/κιλά: 4<br />Κιβώτια ανά παλέτα: 72",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 2300gr",
        },
        {
        ...
        },
        {
            "filename": "agioritikes-kotopita.jpg",
            "categories": "agioritikes",
            "onoma": "01-05-150 Χωριάτικη Αγιορείτικη Κοτόπιτα",
            "keimeno": "Βάρος ανά τεμάχιο: 2300gr",
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 250gr<br />Τεμάχια ανά κιβώτιο/κιλά: 25<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 520gr<br />Τεμάχια ανά κιβώτιο/κιλά: 20<br />Κιβώτια ανά παλέτα: 70",
        },
        {
            "filename": "mpougatsakia-kima.jpg",
            "categories": "mpougatsakia",
            "onoma": "01-02-004 Μπουγατσάκι Τυρί",
            "keimeno": "Βάρος ανά τεμάχιο: 490gr<br />Τεμάχια ανά κιβώτιο/κιλά: 20<br />Κιβώτια ανά παλέτα: 70",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 2300gr<br />Τεμάχια ανά κιβώτιο/κιλά: 5<br />Κιβώτια ανά παλέτα: 54",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 47gr<br />Τεμάχια ανά κιβώτιο/κιλά: 6<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 220gr<br />Τεμάχια ανά κιβώτιο/κιλά: 30<br />Κιβώτια ανά παλέτα: 92",
        },
        {
    ...
    SfoliataImage_data = [
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 200gr<br />Τεμάχια ανά κιβώτιο/κιλά: 30<br />Κιβώτια ανά παλέτα: 88",
        },
        {
            "filename": "sfoliata.jpg",
            "categories": "Sfoliates",
            "onoma": "01-03-002 Σφολιάτα Τρίγωνη 150γρ.",
            "keimeno": "Βάρος ανά τεμάχιο: 150gr<br />Τεμάχια ανά κιβώτιο/κιλά: 35<br />Κιβώτια ανά παλέτα: 92",
        },
        {
            "filename": "sfoliata-loykaniko.jpg",
            "categories": "Sfoliates",
            "onoma": "01-03-004 Σφολιάτα Λουκάνικο Γίγας",
            "keimeno": "Βάρος ανά τεμάχιο: 200gr<br />Τεμάχια ανά κιβώτιο/κιλά: 35<br />Κιβώτια ανά παλέτα: 88",
        },
        {
            "filename": "flogera-kotopoulo.jpg",
            "categories": "Sfoliates",
            "onoma": "01-03-005 Φλογέρα Κοτόπουλο",
            "keimeno": "Βάρος ανά τεμάχιο: 230gr<br />Τεμάχια ανά κιβώτιο/κιλά: 30<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 240gr<br />Τεμάχια ανά κιβώτιο/κιλά: 28<br />Κιβώτια ανά παλέτα: 92",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 48gr<br />Τεμάχια ανά κιβώτιο/κιλά: 6<br />Κιβώτια ανά παλέτα: 88",
        },
        {
            "filename": "kaseropitaki.jpg",
            "categories": "Mini-Sfoliates",
            "onoma": "01-03-101 Κασεροπιτάκι",
            "keimeno": "Βάρος ανά τεμάχιο: 55gr<br />Τεμάχια ανά κιβώτιο/κιλά: 6<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 35gr<br />Τεμάχια ανά κιβώτιο/κιλά: 7<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 230gr<br />Τεμάχια ανά κιβώτιο/κιλά: 24<br />Κιβώτια ανά παλέτα: 92",
        },
        {
            "filename": "sfoliataki-olikis.jpg",
            "categories": "Sfoliates-olikis",
            "onoma": "01-03-452 Μίνι Σφολιατάκι Ολικής Ανθότυρο Γαλοπούλα",
            "keimeno": "Βάρος ανά τεμάχιο: 60gr<br />Τεμάχια ανά κιβώτιο/κιλά: 6<br />Κιβώτια ανά παλέτα: 88",
        },
        {
            "filename": "kroyasan-zampon.jpg",
            "categories": "Zymes-Krouasan",
            "onoma": "01-03-200 Κρουασάν Ζαμπόν Κασέρι Μπέικον",
            "keimeno": "Βάρος ανά τεμάχιο: 260gr<br />Τεμάχια ανά κιβώτιο/κιλά: 25<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 220gr<br />Τεμάχια ανά κιβώτιο/κιλά: 24<br />Κιβώτια ανά παλέτα: 92",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 240gr<br />Τεμάχια ανά κιβώτιο/κιλά: 30<br />Κιβώτια ανά παλέτα: 88",
        },
        {
        ...
        },
        {
            ...
            "keimeno": "Βάρος ανά τεμάχιο: 230gr<br />Τεμάχια ανά κιβώτιο/κιλά: 25<br />Κιβώτια ανά παλέτα: 88",
        },
    ]
