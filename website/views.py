...
def Pites():
    ...
    return render_template("Pites.html", user=current_user, PitesImage_data=PitesImage_data)
...
def Sfoliata():
    ...
    return render_template("Sfoliata.html", user=current_user, SfoliataImage_data=SfoliataImage_data)
